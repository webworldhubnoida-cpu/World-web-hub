...
export const Hero = () => {
  ...
  return (
    <section className="relative w-full pt-[110px] lg:pt-[130px] min-h-screen bg-black overflow-hidden">
      ...
      {/* Content */}
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-10 min-h-[80vh]">

        {/* LEFT */}
        <div className="text-center lg:text-left max-w-xl">
          <span className="text-blue-400 text-sm">{slide.tag}</span>

          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-white mt-4">
            {slide.title}
            <br />
