...
export const StatsSection = () => (
  <section className="py-24 gradient-subtle-bg text-white relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
      <StatItem value="15+" label="Years Experience" delay={0.1} />
      <StatItem value="250+" label="Projects Delivered" delay={0.2} />
      <StatItem value="120+" label="Happy Clients" delay={0.3} />
      <StatItem value="50+" label="Expert Developers" delay={0.4} />

      <StatItem value="98%" label="Client Satisfaction" delay={0.5} />
      <StatItem value="24/7" label="Support Available" delay={0.6} />
      <StatItem value="10+" label="Countries Served" delay={0.7} />
      <StatItem value="5+" label="Years Avg. Partnership" delay={0.8} />
    </div>
  </section>
);
